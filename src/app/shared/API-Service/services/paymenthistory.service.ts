...
export class PaymenthistoryService {
  ...
  public TotalPaidInstallment = new BehaviorSubject(null);
  ...
  Create(data:object):Observable<any>{
   ...
   GetTotalPaidInstallment(studentId:number , studentSubCourseId:number):Observable<any>{
    return this._HttpClient.get(`${environment.Server_URL}/PaymentHistory/GetTheHighestPaidInstallment?studentId=${studentId}&studentSubCourseId=${studentSubCourseId}`);
   }
